...
public class CaraRobot extends GraphicsProgram{
	...
	public void run() {
		...
		/**
		 * Creo la primera parte del cuello y lo añado
		 */
		...
		/**
		 * Creo el ojo izquierdo y lo añado
		 */
		...
		/**
		 * Creo la pupila del ojo izquierdo y la añado
		 */
		...
		/**
		 * Creo el ojo derecho y lo añado
		 */
		...
		/**
		 * Creo la pupila del ojo derecho y la añado
		 */
		...
		/**
		 * Creo la oreja izqueirda y la añado
		 */
		...
		/**
		 * Creo la oreja derecha y la añado
		 */
